...
CREATE TABLE organisation_has_admin (
  organisation_id INT UNSIGNED NOT NULL,
  user_account_id INT UNSIGNED NOT NULL,
  created_at DATETIME NOT NULL,
  PRIMARY KEY (organisation_id,user_account_id)
) ENGINE=InnoDB DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
ALTER TABLE organisation_has_admin ADD CONSTRAINT organisation_has_admin_organisation_id  FOREIGN KEY (organisation_id) REFERENCES organisation(id);
ALTER TABLE organisation_has_admin ADD CONSTRAINT organisation_has_admin_user_account_id  FOREIGN KEY (user_account_id) REFERENCES user_account(id);
