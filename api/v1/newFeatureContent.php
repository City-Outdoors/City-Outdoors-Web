...
if (isset($_FILES['photo']['error']) && in_array($_FILES['photo']['error'], array(UPLOAD_ERR_INI_SIZE,UPLOAD_ERR_FORM_SIZE))) {
	...
	?><data><error code="NEW_FEATURE_CONTENT_PHOTO_TO_BIG">Sorry, The file you uploaded was to big! Please reduce it or comment without it.</error></data><?php
	...
	?><data><error code="NEW_FEATURE_CONTENT_PHOTO_ERROR">Sorry, there was a problem uploading this file. Please try again or contact us for help.</error></data><?php
